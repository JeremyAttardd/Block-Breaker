...
public class Ball : MonoBehaviour {
    ...
    void Start () {
        ...
        randomX = Random.Range(0f, 0.02f);
        randomY = Random.Range(0f, 0.02f);

        //Attaches the object itself rather than having
        //to attach the Paddle myself from Unity
	...
	void Update () {
        ...
        if (!hasStarted) //if hasStarted == false
        {
            ...
            if (Input.GetMouseButtonDown(0)) // Left click
            {
                ...
                this.GetComponent<Rigidbody2D>().velocity = new Vector2(2f, 20f);
